...
<head>
    ...
    <!-- head -->
    <!--<base href="https://avroralepnina.ru/info/partnership" />-->
 ...
 "/>
    ...
    <style type="text/css">.sp-page-builder .page-content #section-id-1509448070272 {
            margin: 0px 0px 0px 0px;
            padding: 20px 0px 0px 0px;
        }

        #sppb-addon-1509460106350 {
            margin: 200;
            padding: 200;
            box-shadow: 0 200 0 0 0;
        }

        #sppb-addon-1509460106350 .sppb-addon-title {
    ...
    <meta content="Сотрудничество" property="og:title"/>
    <meta content="website" property="og:type"/>
    <meta content="https://avroralepnina.ru/info/partnership" property="og:url"/>
            ...
            <div class="sp-column ">
                ...
                <div id="sp-page-builder" class="sp-page-builder  page-35">
                    ...
                    <div class="page-content">
                        <section class="sppb-section " id="section-id-1509448070272">
                            <div class="sppb-row-container">
                                <div class="sppb-row">
                                    <div class="sppb-col-md-6">
                                        <div class="sppb-column" id="column-id-1509448070273">
                                            <div class="sppb-column-addons">
                                                <div class="clearfix" id="sppb-addon-1509460106350">
                                                    <div class="sppb-addon sppb-addon-text-block sppb-text-left ">
                                                        <h6
                                                                class="sppb-addon-title">Сотрудничество:</h6>
                                                        <div class="sppb-addon-content"><span
                                                                    style="font-size: 14pt;">Мы всегда рады новым друзьям и интересным&nbsp;проектам.</span><br/><span
                                    ...
                                    <div class="sppb-col-md-6">
                                        <div class="sppb-column" id="column-id-1509448070276">
                                            <div class="sppb-column-addons">
                                                <div class="clearfix" id="sppb-addon-1509460338342">
                ...
                <ul class="nav menu">
                    ...
                    <li class="item-107  active deeper parent"><a
                        ...
                        <ul class="collapse" id="collapse-menu-107">
                            ...
                            <li class="item-138  current active"><a
                                        href="partnership.php">
                                    Сотрудничество</a></li>

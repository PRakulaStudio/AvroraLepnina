...
<head>
    ...
    <!-- head -->
    <!--<base href="https://avroralepnina.ru/info/prices" />-->
 ...
 "/>
    ...
    <style type="text/css">.sp-page-builder .page-content #section-id-1505893406565 {
        ...
        .sp-page-builder .page-content #section-id-1509447584022 {
            margin: 0px 0px 0px 0px;
            padding: 20px 0px 00px 0px;
        }

        #sppb-addon-1509447635881 .sppb-addon-title {
            font-size: 18px;
            line-height: 18px;
            font-weight: bold;
        }
        ...
        .sp-page-builder .page-content #section-id-1509446276651 {
            margin: 0px 0px 0px 0px;
    ...
    <meta content="О ценах" property="og:title"/>
    <meta content="website" property="og:type"/>
    <meta content="https://avroralepnina.ru/info/prices" property="og:url"/>
            ...
            <div class="sp-column ">
                ...
                <div id="sp-page-builder" class="sp-page-builder  page-33">
                    ...
                    <div class="page-content">
                        <section class="sppb-section " id="section-id-1505893406565">
                            <div class="sppb-row-container">
                                <div class="sppb-row">
                                    <div class="sppb-col-md-12">
                                        <div class="sppb-column" id="column-id-1505893406566">
                                            <div class="sppb-column-addons">
                                                <div class="clearfix" id="sppb-addon-1505893406569">
                        ...
                        <section class="sppb-section " id="section-id-1509447584022">
                            <div class="sppb-row-container">
                                <div class="sppb-row">
                                    <div class="sppb-col-md-6">
                                        <div class="sppb-column" id="column-id-1509447584023">
                                            <div class="sppb-column-addons">
                                                <div class="clearfix" id="sppb-addon-1509447635881">
                                                    <div class="sppb-addon sppb-addon-text-block sppb-text-left ">
                                                        <h6
                                                                class="sppb-addon-title">Заказ лепнины</h6>
                                                        <div class="sppb-addon-content"><p><span
                                                                        style="font-size: 12pt;"><span
                                                                            style="color: #777777;"><span
                                                                                style="font-family: 'Liberation Serif', serif;">При заказе лепнины следует обратить особое внимание на материал, из которого она изготовлена. Основные материалы для изготовления лепнины это гипс, полиуретан и пластик или пенопласт. Делая заказ лепнины, помните, что пластик и пенопласт имеют очень короткий срок службы, теряют свой внешний вид при соприкосновении с мебелью, неустойчивы к внешним воздействиям. Традиционный и экологически чистый материал, проверенный годами &ndash; это гипс. Именно гипсовая лепнина подойдет более всего для создания индивидуального и неповторимого интерьера.&nbsp;</span></span><span
                                                                            style="font-family: 'Liberation Serif', serif;"><br/> <br/> </span><span
                                                                            style="font-family: 'Liberation Serif', serif;">У нас Вы сможете</span><span
                                                                            style="color: #777777;"><span
                                                                                style="font-family: 'Liberation Serif', serif;"> сделать заказ на изготовление лепнины для внешней и внутренней отделки помещений. Заказ лепнины выполняется нашими специалистами в кратчайшие сроки. Изготовление лепнины на заказ может стать первым шагом на пути к гармоничному устройству вашего дома.</span></span></span>
                                                            </p></div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="sppb-col-md-6">
                                        <div class="sppb-column" id="column-id-1509447584024">
                                            <div class="sppb-column-addons">
                                                <div class="clearfix" id="sppb-addon-1509459052301">
                        ...
                        <section class="sppb-section " id="section-id-1509446276651">
                            <div class="sppb-row-container">
                                <div class="sppb-row">
                                    <div class="sppb-col-md-6">
                                        <div class="sppb-column" id="column-id-1509446276652">
                                            <div class="sppb-column-addons">
                                                <div class="clearfix" id="sppb-addon-1509459420255">
                                                    <div class="sppb-addon sppb-addon-single-image sppb-text-center ">
                                                        <div class="sppb-addon-content">
                                                            <div class="sppb-addon-single-image-container"><img
                                                                        alt="102.jpg"
                                    ...
                                    <div class="sppb-col-md-6">
                                        <div class="sppb-column" id="column-id-1509446276653">
                                            <div class="sppb-column-addons">
                                                <div class="clearfix" id="sppb-addon-1509446728871">
                                                    <div class="sppb-addon sppb-addon-text-block sppb-text-left ">
                                                        <div class="sppb-addon-content"><h1
                                                                    class="western"><span
                                                                        style="font-size: 12pt;"><span
                                                                            style="color: #000000;"><span
                                                                                style="font-family: 'Century Gothic', sans-serif;">Стоимость изделий из натурального гипса, очень часто, ниже, чем аналоги из полиуретана. По стоимости монтажа, по смете работ, цена установки лепнины из полиуретана примерно на 20-30% ниже. Но! Стоит рассмотреть условия эксплуатации полиуретановых изделия и все становится ясно.&nbsp;<br/> В договоре эксплуатации пишется, что изделия должны использоваться в помещении со стабильной температурой &ndash; только в таком случае дается гарантия качества. Если температурный режим меняется, может произойти что угодно. В таком случае, виноваты только вы сами. Изделия из гипса не подвержены температурным колебаниям и перепадам влажности.<br/> Кроме того, гипс не дает усадки, на нем не образуется трещин. Природное происхождение этого материала служит гарантией его качества и долговечности. Использование натурального гипса &ndash; настоящая возможность сэкономить!</span></span></span>
                                                            </h1></div>
                                                    </div>
                                                </div>
                                            </div>

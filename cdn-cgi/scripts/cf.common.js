...
!function (e) {
    ...
    function t(e) {
        e = e || {}, this.phrases = e.phrases || {}, this.currentLocale = e.locale || "en"
    }
    ...
    function a(e, t, n) {
        var i, s, o;
        return n != null && e ? (s = e.split(r), o = s[l(t, n)] || s[0], i = u(o)) : i = e, i
    }
    ...
    t.VERSION = "0.2.0", t.prototype.locale = function (e) {
        ...
        return r === "" ? (h('Missing translation for key: "' + e + '"'), n = e) : (t = p(t), t.smart_count != null && t.smart_count.length != null && (t.smart_count = t.smart_count.length), n = a(r, this.currentLocale, t.smart_count), n = c(n, t)), n
    ...
    typeof module != "undefined" && module.exports ? module.exports = t : e.Polyglot = t
}(this);

...
<head>
    ...
    <!-- head -->
    <!--<base href="https://avroralepnina.ru/contacts" />-->
 ...
 "/>
    ...
    <style type="text/css">.sp-page-builder .page-content #section-id-1505973925809 {
        ...
        .sp-page-builder .page-content #section-id-1497371135805 {
            margin: 0px 0px 0px 0px;
            padding: 20px 0px 50px 0px;
        }

        #sppb-addon-1497371135810 .sppb-addon-title {
            font-size: 17px;
            line-height: 17px;
            font-weight: bold;
        }

        #sppb-addon-1497371135810 h3.sppb-addon-title {
            margin: 0px 0px 30px 0px;
            padding: 0px 0px 0px 0px;
            font-weight: bold;
        }

        #sppb-addon-1498733140846 {
            padding: 30px;
        }

        #sppb-addon-1498733140846 .sppb-addon-content {
            margin: -1px;
        }

        #sppb-addon-1498733140846 .sppb-addon-content .sppb-btn {
            margin: 1px;
        }

        #sppb-addon-1498733140846 #btn-1498733140846.sppb-btn-custom {
            background-color: rgba(0, 0, 0, 1);
            color: rgba(255, 255, 255, 1);
        }

        #sppb-addon-1498733140846 #btn-1498733140846.sppb-btn-custom:hover {
            background-color: rgba(0, 0, 0, 1);
            color: rgba(255, 255, 255, 1);
        }

        #sppb-addon-1498733140846 #btn-1498733140847.sppb-btn-custom {
            background-color: rgba(0, 0, 0, 1);
            color: rgba(255, 255, 255, 1);
        }

        #sppb-addon-1498733140846 #btn-1498733140847.sppb-btn-custom:hover {
            background-color: rgba(0, 0, 0, 1);
            color: rgba(255, 255, 255, 1);
        }

        #sppb-addon-1498733140846 #btn-1498733140848.sppb-btn-custom {
            background-color: rgba(0, 0, 0, 1);
            color: rgba(255, 255, 255, 1);
        }

        #sppb-addon-1498733140846 #btn-1498733140848.sppb-btn-custom:hover {
            background-color: rgba(0, 0, 0, 1);
            color: rgba(255, 255, 255, 1);
        }

        #sppb-addon-1497371135813 {
            margin: auto auto;
        }

        #sppb-addon-1526053501591 {
            margin: auto auto;
        }
    ...
    <meta content="https://avroralepnina.ru/contacts" property="og:url"/>
            ...
            <div class="sp-column ">
                ...
                <div id="sp-page-builder" class="sp-page-builder  page-7">
                    ...
                    <div class="page-content">
                        <section class="sppb-section " id="section-id-1505973925809">
                            <div class="sppb-row-container">
                                <div class="sppb-row">
                                    <div class="sppb-col-md-12">
                                        <div class="sppb-column" id="column-id-1505973925810">
                                            <div class="sppb-column-addons">
                                                <div class="clearfix" id="sppb-addon-1505973952359">
                                                    <div class="sppb-addon sppb-addon-single-image sppb-text-center head">
                                                        <div class="sppb-addon-content">
                                                            <div class="sppb-addon-single-image-container"><img
                                                                        ...
                                                                        src="https://avroralepnina.ru/images/2017/09/10/cont.jpg"
                                                                        title=""></div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="sppb-column" id="column-id-1497371135807">
                                            <div class="sppb-column-addons">
                                                <div class=" sppb-wow zoomInRight clearfix"
                                                     data-sppb-wow-delay="98ms"
                                                     data-sppb-wow-duration="600ms"
                                                     id="sppb-addon-1497371135813">
        ...
        <div class="sp-module "><h3 class="sp-module-title">Навигация</h3>
            <div class="sp-module-content">
                <ul class="nav menu">
                    ...
                    <li class="item-108  current active deeper parent"><a
